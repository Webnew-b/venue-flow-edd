...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(
                m20250815_114355_fk_organizer_to_rental_request::Migration,
            ),
            ...
            Box::new(
                m20250906_062421_remove_images_column_from_venue::Migration,
            ),
            Box::new(m20250906_063933_change_allow_activity_to_enum::Migration),
            Box::new(
                m20250906_065650_add_create_time_to_venue_image::Migration,
            ),
